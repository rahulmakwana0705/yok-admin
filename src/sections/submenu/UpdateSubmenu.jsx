            ...
            columns: prevData.columns.map((column, index) => {
                if (index === columnIndex) {
                    return {
                        ...
                        columnItems: [
                            ...(column.columnItems || []),
                            { id: (column.columnItems || []).length + 1, path: '', label: '', columnItemItems: [] }
                        ]
                    };
                }
                return column;
                                ...
                                <Grid container spacing={1} sx={{ marginBottom: 1 }}>
                                    <Grid item xs={6}>
                                        <TextField
                                            ...
                                            onChange={(e) => handleColumnItemInputChange(columnIndex, columnItemIndex, 'path', e.target.value)}
                                        />
                                    </Grid>
                                    <Grid item xs={6}>
                                        <TextField
                                            ...
                                            onChange={(e) => handleColumnItemInputChange(columnIndex, columnItemIndex, 'label', e.target.value)}
                                        />
                                    </Grid>
                                </Grid>
                                        ...
                                        <Grid container spacing={1} sx={{ marginBottom: 1 }}>
                                            <Grid item xs={6}>
                                                <TextField
                                                    ...
                                                    onChange={(e) => {/* handleColumnItemItemInputChange */ }}
                                                />
                                            </Grid>
                                            <Grid item xs={6}>
                                                <TextField
